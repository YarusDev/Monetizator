...
const QUIZ_STEPS: QuizStep[] = [
  {
    question: "Работаете ли вы со своей текущей базой клиентов?",
    options: ["Вообще нет", "Иногда делаю рассылки", "Есть системная воронка возврата"],
    insight: "База — это ваш 'мешок с золотом'. Возврат старого клиента в 5-7 раз дешевле привлечения нового."
  },
  {
    question: "Есть ли у вас 'продукт-вход' (дешевый или бесплатный шаг)?",
    options: ["Продаю сразу основной продукт", "Есть консультация/аудит", "Есть автоматизированный лид-магнит"],
    insight: "Без 'мягкого входа' вы переплачиваете за рекламу. Клиенту нужно сначала 'попробовать' вашу экспертность."
  },
  {
    question: "Как часто клиенты приходят к вам по рекомендации?",
    options: ["Стихийно (как повезет)", "Редко, не управляю этим", "Есть система лояльности/партнерка"],
    insight: "Сарафанное радио можно превратить в прогнозируемый канал трафика через правильные коллаборации."
  },
  {
    question: "Оценивали ли вы стоимость привлечения 1 клиента (CAC)?",
    options: ["Нет, не считаю цифры", "Примерно знаю", "Считаю до рубля каждую неделю"],
    insight: "Не зная стоимости клиента, вы масштабируете хаос, а не прибыль."
  },
  {
    question: "Какова ваша маржинальность (сколько денег остается вам)?",
    options: ["Меньше 20%", "20% - 50%", "Более 50%"],
    insight: "Часто прибыль 'съедается' операционкой. Мы найдем способ поднять чек без потери конверсии."
  }
];
